...
ConfigData = {
 ...
 ANALOG_TO_DIGITAL_INPUTS_1 = {
   ...
   { Line='AI2', Name='I0.SYp', Enbl='yes',Type='V_CORRECTED', DLog=1, Coefs={'1.0','250.0','-25.0','1.0','1.0',} },
   ...
   { Line='AI6', Name='I0.TWt', Enbl='no', Type='V_LINEAR_CORRECTION', DLog=1, Coefs={'100.0','0.0','1.0','1.0','1.0',} },
   { Line='AI7', Name='I0.TWl', Enbl='no', Type='V_LINEAR_CORRECTION', DLog=1, Coefs={'1.0','0.0','1.0','1.0','1.0',} },
   { Line='AI8', Name='I0.SYw', Enbl='no', Type='V_LINEAR_CORRECTION', DLog=1, Coefs={'252.38','0.0','1.0','1.0','1.0',} },
 },
 ANALOG_TO_DIGITAL_INPUTS_2 = {
   ...
   { Line='AI10', Name='I0.CLt', Enbl='no',  Type='V_LINEAR_CORRECTION', DLog=1, Coefs={'100.0','0.0','1.0','1.0','1.0',} },
   { Line='AI11', Name='I0.WSt', Enbl='yes', Type='V_LINEAR_CORRECTION', DLog=1, Coefs={'100.0','0.0','1.0','1.0','1.0',} },
   { Line='AI12', Name='I0.CSt', Enbl='yes', Type='V_LINEAR_CORRECTION', DLog=1, Coefs={'100.0','0.0','1.0','1.0','1.0',} },
   { Line='AI13', Name='I0.CBt', Enbl='yes', Type='V_LINEAR_CORRECTION', DLog=1, Coefs={'100.0','0.0','1.0','1.0','1.0',} },
